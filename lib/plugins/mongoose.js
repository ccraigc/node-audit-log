...
var MongoosePlugin = function(options) {
    ...
    this.handler = function(schema, options) {
        ...
        schema.post('save', function (doc) {
            ...
            self._options.auditLog.logEvent(self.auditLog._userId, 'mongoose', 'save', self._options.modelName, docObj[self._options.idPath], description);
        });
        ...
        schema.post('remove', function(doc) {
            ...
            self._options.auditLog.logEvent(self.auditLog._userId, 'mongoose', 'remove', self._options.modelName, docObj[self._options.idPath], description);
        });
    }
}
